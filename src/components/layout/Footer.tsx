...
const socialLinks = [
    {
        name: "LinkedIn",
        href: "https://www.linkedin.com/company/goxt/?viewAsMember=true",
        icon: (
    ...
    {
        name: "Instagram",
        href: "https://www.instagram.com/goxt_innovacion/",
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
        name: "Facebook",
        href: "https://www.facebook.com/profile.php?id=61587279490575",
        icon: (
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
